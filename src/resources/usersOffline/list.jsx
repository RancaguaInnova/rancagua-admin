...
import { Datagrid, FunctionField, EditButton, Filter, List, TextField, TextInput,SimpleList } from 'react-admin'
...
const UserList = props => {
  ...
  <List {...props} title={'Listado de Usuarios Offline'}  filters={<UsersFilter />}>
    {isSmall ? (
      <SimpleList
    ...
    <Datagrid >
      <FunctionField label="Rut" render={record => `${format(record.number)} `} />
      ...
      {props.hasEdit && (
        <EditButton label="Editar"></EditButton>
      )}
    </Datagrid>
      )
    }
